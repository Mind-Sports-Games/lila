...
object header {
  ...
  def apply(
    ...
    frag(
      ...
      (info.countDisplayedTrophies > 0).option(
        ...
        case _                             =>
          ...
          div(id := "us_profile")(
            ...
            div(cls := "profile-side")(
              ...
              // TODO Change insights to be about all games not just chess
