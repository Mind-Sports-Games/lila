          ...
          ul(
            history.map { e =>
              li(
                ...
                b(e.showAction),
                " ",
                e.gameId.fold[Frag]((~e.details: String)) { gameId =>
                  a(href := s"${routes.Round.watcher(gameId, "p1").url}?pov=${~e.user}")(~e.details: String)
                },
                " ",
        ...
        thead(
          tr(
            th(
              ...
              (max < 1000 && true || othersWithEmail.others.sizeIs >= max).option(
                frag(
                  nbsp,
        ...
        tbody(
          othersWithEmail.others.map { case other @ UserLogins.OtherUser(o, _, _) =>
            ...
            tr(
              ...
              markTd(~bans.get(o.id): Int, playban(cls := "text")(~bans.get(o.id): Int)),
