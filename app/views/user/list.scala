        ...
        div(cls := "community page-menu__content box box-pad")(
          ...
          div(cls := "community__leaders")(
            ...
            div(cls := "leaderboards")(
              ...
              userTopPerf(leaderboards.dameo, PerfType.orDefault("dameo")),
              ...
              userTopPerf(leaderboards.antiflipello, PerfType.orDefault("antiflipello")),
              userTopPerf(leaderboards.octagonflipello, PerfType.orDefault("octagonflipello")),
              ...
              userTopPerf(leaderboards.bestemshe, PerfType.orDefault("bestemshe")),
