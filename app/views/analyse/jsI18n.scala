...
private object jsI18n {
  ...
  private val i18nKeys = List(
    ...
    trans.next,
    trans.xWasPlayed,
    trans.findBetterMoveForSGPlayer,
    trans.resumeLearning,
    trans.youCanDoBetter,
    trans.tryAnotherMoveForSGPlayer,
    trans.solution,
    trans.waitingForAnalysis,
    trans.noMistakesFoundForSGPlayer,
    trans.doneReviewingSGPlayerMistakes,
    trans.doItAgain,
    trans.reviewSGPlayerMistakes,
