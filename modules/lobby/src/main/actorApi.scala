...
private[lobby] case class JoinHook(sri: Sri, hook: Hook, game: Game, creatorSGPlayer: strategygames.Player)
private[lobby] case class JoinSeek(userId: String, seek: Seek, game: Game, creatorSGPlayer: strategygames.Player)
