...
private[lobby] case class JoinHook(sri: Sri, hook: Hook, game: Game, creatorColor: strategygames.chess.Color)
private[lobby] case class JoinSeek(userId: String, seek: Seek, game: Game, creatorColor: strategygames.chess.Color)
