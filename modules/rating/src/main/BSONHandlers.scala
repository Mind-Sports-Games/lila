...
object BSONHandlers {
  ...
  implicit val perfTypeIdHandler: BSONHandler[PerfType]  = intIsoHandler(using perfTypeIdIso)
  implicit val perfTypeKeyHandler: BSONHandler[PerfType] = stringIsoHandler(using perfTypeKeyIso)
}
