  ...
  implicit val prefBSONHandler: BSON[Pref] = new BSON[Pref] {
    ...
    def reads(r: BSON.Reader): Pref =
      Pref(
        ...
        actionReminder = r.getD("actionReminder", Pref.default.actionReminder),
        ...
        confirmCubeActions = r.getD("confirmCubeActions", Pref.default.confirmCubeActions),
    ...
    def writes(w: BSON.Writer, o: Pref) =
      $doc(
        ...
        "actionReminder"      -> o.actionReminder,
        "coords"              -> o.coords,
        "replay"              -> o.replay,
        ...
        "confirmCubeActions"  -> o.confirmCubeActions,
