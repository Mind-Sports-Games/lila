...
object PrefForm {
  ...
  val pref = Form(
    mapping(
      ...
      )(BehaviorData.apply)(d => Some((d.moveEvent, d.mancalaMove, d.premove, d.takeback, d.autoQueen, d.autoThreefold, d.submitMove, d.confirmResign, d.confirmPass, d.playForcedAction, d.keyboardMove, d.rookCastle))),
      "clock" -> mapping(
    ...
    def apply(pref: Pref): PrefData =
      PrefData(
        display = DisplayData(
          ...
          actionReminder = if (pref.actionReminder) 1 else 0,
