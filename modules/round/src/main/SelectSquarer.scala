...
import lila.game.{ Event, Game, Player as GamePlayer, Pov, Progress }
...
final private[round] class SelectSquarer(
    messenger: Messenger,
    @annotation.nowarn("msg=unused") _finisher: Finisher,
    @annotation.nowarn("msg=unused") _prefApi: PrefApi,
    @annotation.nowarn("msg=unused") _isBotSync: lila.common.LightUser.IsBotSync
