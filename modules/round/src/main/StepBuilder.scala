      ...
      case (init, games, error) =>
        ...
        JsArray {
          val initStep = Step(
            ...
            currentPointValueP1 = init.situation.pointValue(Some(Player.P1)),
            currentPointValueP2 = init.situation.pointValue(Some(Player.P2)),
            dests = None,
            drops = None,
          ...
          val moveSteps = games.map { case (g, m) =>
            Step(
              ...
              currentPointValueP1 = g.situation.pointValue(Some(Player.P1)),
              currentPointValueP2 = g.situation.pointValue(Some(Player.P2)),
              dests = None,
              drops = None,
