...
object PoolList {
  ...
  val all: List[PoolConfig] = List(
    ...
    PoolConfig(1 ++ 0, Wave(12 seconds, 40 players), Variant.Standard),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.Standard),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.International),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.LinesOfAction),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.Shogi),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.Xiangqi),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.Flipello),
    PoolConfig(3 ++ 2, Wave(22 seconds, 30 players), Variant.Oware)
  )
