...
class BinaryCLMTest extends munit.FunSuite {
  ...
  test("write") {
    ...
    assertEquals(write(clmt.copy(castles = clmt.castles without P1)), "00110000" :: _0_ :: Nil)
    assertEquals(write(clmt.copy(castles = clmt.castles.without(P2, QueenSide))), "11100000" :: _0_ :: Nil)
  ...
  test("read") {
    ...
    assertEquals(read("00110000" :: _0_ :: List.fill(3)(_0_)), clmt.copy(castles = clmt.castles without P1))
    assertEquals(read("11100000" :: _0_ :: List.fill(3)(_0_)), clmt.copy(castles = clmt.castles.without(P2, QueenSide)))
    assertEquals(read("00000000" :: "00000001" :: List.fill(3)(_0_)), clmt.copy(castles = Castles.none, lastMove = Uci("a1a2")))
