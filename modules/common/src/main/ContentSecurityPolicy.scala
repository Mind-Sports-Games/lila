...
case class ContentSecurityPolicy(
  ...
  def withPayPal =
    copy(
      connectSrc = List("https://www.paypal.com", "https://*.paypal.com") ::: connectSrc,
      scriptSrc = List("https://www.paypal.com", "https://*.paypal.com") ::: scriptSrc,
      frameSrc = List("https://www.paypal.com", "https://*.paypal.com") ::: frameSrc
    )
  ...
  private def withPrismicEditor(maybe: Boolean): ContentSecurityPolicy =
    if (maybe)
      copy(
        ...
        frameSrc = "https://playstrategy.prismic.io" :: "https://playstrategy.cdn.prismic.io" :: frameSrc,
        connectSrc = "https://playstrategy.prismic.io" :: "https://playstrategy.cdn.prismic.io" :: connectSrc
      )
    else this
