...
val `microMatch` = new I18nKey("microMatch")
val `microMatchChallenge` = new I18nKey("microMatchChallenge")
val `microMatchRematchStarted` = new I18nKey("microMatchRematchStarted")
val `microMatchRematchAwaiting` = new I18nKey("microMatchRematchAwaiting")
val `microMatchGameX` = new I18nKey("microMatchGameX")
val `microMatchDefinition` = new I18nKey("microMatchDefinition")
...
val `useMatchScore` = new I18nKey("useMatchScore")
val `useMatchScoreDefinition` = new I18nKey("useMatchScoreDefinition")
