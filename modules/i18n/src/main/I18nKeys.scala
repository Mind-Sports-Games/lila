...
val `playstrategyIsForkedFromLichess` = new I18nKey("faq:playstrategyIsForkedFromLichess")
val `areThereWebsitesBasedOnPlayStrategy` = new I18nKey("faq:areThereWebsitesBasedOnPlayStrategy")
