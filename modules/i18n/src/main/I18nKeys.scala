...
val `red` = new I18nKey("red")
val `sente` = new I18nKey("sente")
val `gote` = new I18nKey("gote")
val `p1` = new I18nKey("p1")
val `p2` = new I18nKey("p2")
val `randomColor` = new I18nKey("randomColor")
val `absentSimulApplicants` = new I18nKey("absentSimulApplicants")
val `gameGroup` = new I18nKey("gameGroup")
val `gameLibrary` = new I18nKey("gameLibrary")
val `memoryGame` = new I18nKey("memoryGame")
val `findPairs` = new I18nKey("findPairs")
val `multiMatch` = new I18nKey("multiMatch")
val `multiMatchChallenge` = new I18nKey("multiMatchChallenge")
val `multiMatchRematchStarted` = new I18nKey("multiMatchRematchStarted")
val `multiMatchRematchAwaiting` = new I18nKey("multiMatchRematchAwaiting")
val `multiMatchGameX` = new I18nKey("multiMatchGameX")
val `multiMatchDefinition` = new I18nKey("multiMatchDefinition")
val `isMatchScore` = new I18nKey("isMatchScore")
val `isMatchScoreDefinition` = new I18nKey("isMatchScoreDefinition")
val `createAGame` = new I18nKey("createAGame")
val `playerIndexIsVictorious` = new I18nKey("playerIndexIsVictorious")
val `whiteIsVictorious` = new I18nKey("whiteIsVictorious")
val `blackIsVictorious` = new I18nKey("blackIsVictorious")
val `promotion` = new I18nKey("promotion")
val `youPlayPieces` = new I18nKey("youPlayPieces")
val `youPlayThePlayerIndexPieces` = new I18nKey("youPlayThePlayerIndexPieces")
...
val `fiveChecks` = new I18nKey("fiveChecks")
val `raceFinished` = new I18nKey("raceFinished")
val `checkersConnected` = new I18nKey("checkersConnected")
val `gameFinished` = new I18nKey("gameFinished")
val `backgammonSingleWin` = new I18nKey("backgammonSingleWin")
val `backgammonGammonWin` = new I18nKey("backgammonGammonWin")
val `backgammonBackgammonWin` = new I18nKey("backgammonBackgammonWin")
val `variantEnding` = new I18nKey("variantEnding")
val `gameFinishedRepetition` = new I18nKey("gameFinishedRepetition")
...
val `playerIndexPlays` = new I18nKey("playerIndexPlays")
...
val `playerIndexResignedMatch` = new I18nKey("playerIndexResignedMatch")
...
val `p1DrawP2` = new I18nKey("p1DrawP2")
...
val `perpetualWarning` = new I18nKey("perpetualWarning")
val `perpetualWarningOpponent` = new I18nKey("perpetualWarningOpponent")
val `subsequentPassWarning` = new I18nKey("subsequentPassWarning")
...
val `gameNumberX` = new I18nKey("gameNumberX")
...
val `clockTypes` = new I18nKey("clockTypes")
...
val `medleyArenaDefinition` = new I18nKey("medleyArenaDefinition")
val `medleyInterval` = new I18nKey("medleyInterval")
val `medleyIntervalDefinition` = new I18nKey("medleyIntervalDefinition")
val `medleyVariantsXMinutesEach` = new I18nKey("medleyVariantsXMinutesEach")
val `medleyBalanceIntervalTimes` = new I18nKey("medleyBalanceIntervalTimes")
val `medleyIntervalOptionDefn` = new I18nKey("medleyIntervalOptionDefn")
val `medleyBalanceIntervalDefn` = new I18nKey("medleyBalanceIntervalDefn")
val `timeControl` = new I18nKey("timeControl")
val `realTime` = new I18nKey("realTime")
val `byoyomiTime` = new I18nKey("byoyomiTime")
val `bronsteinDelay` = new I18nKey("bronsteinDelay")
val `simpleDelay` = new I18nKey("simpleDelay")
...
val `playerIndexTimeOut` = new I18nKey("playerIndexTimeOut")
val `whiteTimeOut` = new I18nKey("whiteTimeOut")
val `blackTimeOut` = new I18nKey("blackTimeOut")
val `playerIndexDidntMove` = new I18nKey("playerIndexDidntMove")
val `playerIndexLosesByGammonTimeOut` = new I18nKey("playerIndexLosesByGammonTimeOut")
val `playerIndexLosesByBackgammonTimeOut` = new I18nKey("playerIndexLosesByBackgammonTimeOut")
val `playerIndexWinsByRuleOfGin` = new I18nKey("playerIndexWinsByRuleOfGin")
val `playerIndexWinsByGinGammon` = new I18nKey("playerIndexWinsByGinGammon")
val `playerIndexWinsByGinBackgammon` = new I18nKey("playerIndexWinsByGinBackgammon")
val `playerIndexOffersSelectSquares` = new I18nKey("playerIndexOffersSelectSquares")
val `selectSquareOfferDeclined` = new I18nKey("selectSquareOfferDeclined")
val `selectSquareOfferAccepted` = new I18nKey("selectSquareOfferAccepted")
...
val `playerIndexOffersDraw` = new I18nKey("playerIndexOffersDraw")
val `whiteOffersDraw` = new I18nKey("whiteOffersDraw")
val `blackOffersDraw` = new I18nKey("blackOffersDraw")
val `playerIndexDeclinesDraw` = new I18nKey("playerIndexDeclinesDraw")
...
val `handicapped` = new I18nKey("handicapped")
val `handicappedTournament` = new I18nKey("handicappedTournament")
val `handicapTournaments` = new I18nKey("handicapTournaments")
val `handicappedDefinition` = new I18nKey("handicappedDefinition")
val `mcmahon` = new I18nKey("mcmahon")
val `mcmahonDefinition` = new I18nKey("mcmahonDefinition")
val `mcmahonCutoff` = new I18nKey("mcmahonCutoff")
val `mcmahonCutoffDefinition` = new I18nKey("mcmahonCutoffDefinition")
val `backgammonPointsDefinition` = new I18nKey("backgammonPointsDefinition")
...
val `goHandicap` = new I18nKey("goHandicap")
val `goKomi` = new I18nKey("goKomi")
val `backgammonPoints` = new I18nKey("backgammonPoints")
...
val `playstrategySiteDescription` = new I18nKey("playstrategySiteDescription")
val `playstrategySiteTitle` = new I18nKey("playstrategySiteTitle")
val `playstrategySiteTitleShort` = new I18nKey("playstrategySiteTitleShort")
val `playVariantOnlineFree` = new I18nKey("playVariantOnlineFree")
val `playVariantOnlineFreeTitle` = new I18nKey("playVariantOnlineFreeTitle")
val `variantRulesTitle` = new I18nKey("variantRulesTitle")
...
val `msoWorldChampionshipVenue` = new I18nKey("msoWorldChampionshipVenue")
...
val `msoGrandPrix` = new I18nKey("msoGrandPrix")
val `recurringTournaments` = new I18nKey("recurringTournaments")
val `variantPuzzles` = new I18nKey("variantPuzzles")
val `libraryTitle` = new I18nKey("libraryTitle")
val `libraryDescription` = new I18nKey("libraryDescription")
...
val `dailyPuzzle` = new I18nKey("dailyPuzzle")
val `featuredGame` = new I18nKey("featuredGame")
val `gameInfo` = new I18nKey("gameInfo")
...
val `playerIndexCheckmatesInOneMove` = new I18nKey("playerIndexCheckmatesInOneMove")
...
val `nowPairingX` = new I18nKey("nowPairingX")
...
val `standByXForY` = new I18nKey("standByXForY")
...
val `turnsPlayed` = new I18nKey("turnsPlayed")
val `playerIndexWins` = new I18nKey("playerIndexWins")
...
val `watchPlayStrategyTV` = new I18nKey("watchPlayStrategyTV")
val `previouslyOnPlayStrategyTV` = new I18nKey("previouslyOnPlayStrategyTV")
...
val `clockDelay` = new I18nKey("clockDelay")
val `clockByoyomi` = new I18nKey("clockByoyomi")
val `numberOfPeriods` = new I18nKey("numberOfPeriods")
val `useByoyomi` = new I18nKey("useByoyomi")
val `useBronsteinDelay` = new I18nKey("useBronsteinDelay")
val `useSimpleDelay` = new I18nKey("useSimpleDelay")
...
val `fieldnumbers8x8` = new I18nKey("fieldnumbers8x8")
val `algebraic8x8` = new I18nKey("algebraic8x8")
...
val `connectedToPlayStrategy` = new I18nKey("connectedToPlayStrategy")
...
val `playstrategyAboutSummary` = new I18nKey("playstrategyAboutSummary")
...
val `hostPlayerIndexX` = new I18nKey("hostPlayerIndexX")
...
val `playstrategyTournaments` = new I18nKey("playstrategyTournaments")
...
val `networkLagBetweenYouAndPlayStrategy` = new I18nKey("networkLagBetweenYouAndPlayStrategy")
val `timeToProcessAMoveOnPlayStrategyServer` = new I18nKey("timeToProcessAMoveOnPlayStrategyServer")
...
val `inKidModeThePlayStrategyLogoGetsIconX` = new I18nKey("inKidModeThePlayStrategyLogoGetsIconX")
...
val `asFreeAsPlayStrategy` = new I18nKey("asFreeAsPlayStrategy")
...
val `friend` = new I18nKey("friend")
val `bot` = new I18nKey("bot")
...
val `colorTheme` = new I18nKey("colorTheme")
...
val `directlySupportPlayStrategy` = new I18nKey("directlySupportPlayStrategy")
val `playChessInStyle` = new I18nKey("playChessInStyle")
val `playInStyle` = new I18nKey("playInStyle")
...
val `playerIndexWinsGame` = new I18nKey("playerIndexWinsGame")
...
val `findBetterMoveForPlayerIndex` = new I18nKey("findBetterMoveForPlayerIndex")
...
val `tryAnotherMoveForPlayerIndex` = new I18nKey("tryAnotherMoveForPlayerIndex")
...
val `noMistakesFoundForPlayerIndex` = new I18nKey("noMistakesFoundForPlayerIndex")
...
val `doneReviewingPlayerIndexMistakes` = new I18nKey("doneReviewingPlayerIndexMistakes")
...
val `reviewPlayerIndexMistakes` = new I18nKey("reviewPlayerIndexMistakes")
...
val `pleasantGameExperience` = new I18nKey("pleasantGameExperience")
...
val `seeOurListOfBots` = new I18nKey("seeOurListOfBots")
val `orUpper` = new I18nKey("orUpper")
val `playAgainstX` = new I18nKey("playAgainstX")
val `weeklyChallenge` = new I18nKey("weeklyChallenge")
val `learnHowToPlay` = new I18nKey("learnHowToPlay")
...
val `nbLiveGamesInPlay` = new I18nKey("nbLiveGamesInPlay")
val `nbCorrespondenceGamesInPlay` = new I18nKey("nbCorrespondenceGamesInPlay")
...
val `nbSecondsToOfferDeadStones` = new I18nKey("nbSecondsToOfferDeadStones")
val `nbSecondsForOpponentToOfferDeadStones` = new I18nKey("nbSecondsForOpponentToOfferDeadStones")
val `nbSecondsToRespondToOffer` = new I18nKey("nbSecondsToRespondToOffer")
val `nbSecondsForOpponentToRespondToOffer` = new I18nKey("nbSecondsForOpponentToRespondToOffer")
...
val `isItHandicapped` = new I18nKey("arena:isItHandicapped")
val `isHandicapped` = new I18nKey("arena:isHandicapped")
val `isNotHandicapped` = new I18nKey("arena:isNotHandicapped")
val `someHandicapped` = new I18nKey("arena:someHandicapped")
...
val `tournamentStatusScoring` = new I18nKey("arena:tournamentStatusScoring")
val `someStatusScoring` = new I18nKey("arena:someStatusScoring")
...
val `howDoArenaMedleysWork` = new I18nKey("arena:howDoArenaMedleysWork")
val `isTournamentMedley` = new I18nKey("arena:isTournamentMedley")
val `someMedley` = new I18nKey("arena:someMedley")
...
val `cycle` = new I18nKey("arena:cycle")
val `wildcard` = new I18nKey("arena:wildcard")
val `shield` = new I18nKey("arena:shield")
val `yearly` = new I18nKey("arena:yearly")
val `cycleDescription` = new I18nKey("arena:cycleDescription")
val `wildcardDescription` = new I18nKey("arena:wildcardDescription")
...
val `logInToPlayStrategy` = new I18nKey("emails:logInToPlayStrategy")
...
val `getAFreePlayStrategyAccount` = new I18nKey("learn:getAFreePlayStrategyAccount")
...
val `averageScoreAsPlayerIndexX` = new I18nKey("coordinates:averageScoreAsPlayerIndexX")
...
val `playerIndexIsSlightlyBetter` = new I18nKey("study:playerIndexIsSlightlyBetter")
...
val `playerIndexIsBetter` = new I18nKey("study:playerIndexIsBetter")
val `whiteIsBetter` = new I18nKey("study:whiteIsBetter")
val `blackIsBetter` = new I18nKey("study:blackIsBetter")
val `playerIndexIsWinning` = new I18nKey("study:playerIndexIsWinning")
...
object clas {
val `playstrategyClasses` = new I18nKey("class:playstrategyClasses")
...
val `applyToBePlayStrategyTeacher` = new I18nKey("class:applyToBePlayStrategyTeacher")
...
val `addPlayStrategyUsernames` = new I18nKey("class:addPlayStrategyUsernames")
...
val `playstrategyProfileXCreatedForY` = new I18nKey("class:playstrategyProfileXCreatedForY")
val `studentCredentials` = new I18nKey("class:studentCredentials")
val `inviteAPlayStrategyAccount` = new I18nKey("class:inviteAPlayStrategyAccount")
...
val `createANewPlayStrategyAccount` = new I18nKey("class:createANewPlayStrategyAccount")
...
val `playstrategyUsername` = new I18nKey("class:playstrategyUsername")
...
val `contactPlayStrategy` = new I18nKey("contact:contactPlayStrategy")
...
val `buyingPlayStrategy` = new I18nKey("contact:buyingPlayStrategy")
...
val `playstrategyPatron` = new I18nKey("patron:playstrategyPatron")
...
val `freeGames` = new I18nKey("patron:freeGames")
...
val `weAreFree` = new I18nKey("patron:weAreFree")
...
val `patronPerks` = new I18nKey("patron:patronPerks")
val `featuresComparison` = new I18nKey("patron:featuresComparison")
val `watkinsAddress` = new I18nKey("patron:watkinsAddress")
val `playstrategyAddress` = new I18nKey("patron:playstrategyAddress")
...
object coach {
val `playstrategyCoaches` = new I18nKey("coach:playstrategyCoaches")
val `playstrategyCoach` = new I18nKey("coach:playstrategyCoach")
...
object streamer {
val `playstrategyStreamers` = new I18nKey("streamer:playstrategyStreamers")
val `playstrategyStreamer` = new I18nKey("streamer:playstrategyStreamer")
...
val `howDoYouMoveMancalaSeeds` = new I18nKey("preferences:howDoYouMoveMancalaSeeds")
val `singleClick` = new I18nKey("preferences:singleClick")
val `clickTwoHouses` = new I18nKey("preferences:clickTwoHouses")
...
val `teamLameName` = new I18nKey("team:teamLameName")
...
val `winnerPlayerIndex` = new I18nKey("search:winnerPlayerIndex")
...
val `cycleXArena` = new I18nKey("tourname:cycleXArena")
val `cycleX` = new I18nKey("tourname:cycleX")
val `wildcardXArena` = new I18nKey("tourname:wildcardXArena")
val `wildcardX` = new I18nKey("tourname:wildcardX")
...
val `whyIsPlayStrategyCalledPlayStrategy` = new I18nKey("faq:whyIsPlayStrategyCalledPlayStrategy")
val `whatIsPlayStrategy` = new I18nKey("faq:whatIsPlayStrategy")
val `playstrategyCombinationLiveLightLibrePronounced` = new I18nKey("faq:playstrategyCombinationLiveLightLibrePronounced")
val `playstrategyAboutSummary` = new I18nKey("faq:playstrategyAboutSummary")
...
val `howCanIContributeToPlayStrategy` = new I18nKey("faq:howCanIContributeToPlayStrategy")
val `canIDonateToPlayStrategy` = new I18nKey("faq:canIDonateToPlayStrategy")
val `playstrategyFundedByDonations` = new I18nKey("faq:playstrategyFundedByDonations")
val `playstrategyPoweredByDonationsAndVolunteers` = new I18nKey("faq:playstrategyPoweredByDonationsAndVolunteers")
...
val `howAreWeDifferentFromLichess` = new I18nKey("faq:howAreWeDifferentFromLichess")
val `playstrategySupportsDifferentAbstractGames` = new I18nKey("faq:playstrategySupportsDifferentAbstractGames")
val `yesPlayStrategyInspiredOtherOpenSourceWebsites` = new I18nKey("faq:yesPlayStrategyInspiredOtherOpenSourceWebsites")
...
val `whatGamesCanIplay` = new I18nKey("faq:whatGamesCanIplay")
val `playstrategyGamesList` = new I18nKey("faq:playstrategyGamesList")
val `whatVariantsCanIplay` = new I18nKey("faq:whatVariantsCanIplay")
val `playstrategySupportChessAnd` = new I18nKey("faq:playstrategySupportChessAnd")
val `eightVariants` = new I18nKey("faq:eightVariants")
val `variantList` = new I18nKey("faq:variantList")
...
val `playstrategyFollowFIDErules` = new I18nKey("faq:playstrategyFollowFIDErules")
...
val `playstrategyTraining` = new I18nKey("faq:playstrategyTraining")
...
val `titlesAvailableOnPlayStrategy` = new I18nKey("faq:titlesAvailableOnPlayStrategy")
val `playstrategyRecognizeAllOTBtitles` = new I18nKey("faq:playstrategyRecognizeAllOTBtitles")
...
val `playstrategyRatings` = new I18nKey("faq:playstrategyRatings")
val `whichRatingSystemUsedByPlayStrategy` = new I18nKey("faq:whichRatingSystemUsedByPlayStrategy")
val `ratingSystemUsedByPlayStrategy` = new I18nKey("faq:ratingSystemUsedByPlayStrategy")
...
val `whatIsInputRating` = new I18nKey("faq:whatIsInputRating")
val `inputRatingExplanation` = new I18nKey("faq:inputRatingExplanation")
val `handicappedTournament` = new I18nKey("faq:handicappedTournament")
...
val `havePlayedARatedGameAtLeastOneYearAgo` = new I18nKey("faq:havePlayedARatedGameAtLeastOneYearAgo")
...
val `leaderboardIncludesStableAndProvisional` = new I18nKey("faq:leaderboardIncludesStableAndProvisional")
val `howDoesTheSheildLeaderboardWork` = new I18nKey("faq:howDoesTheSheildLeaderboardWork")
val `shieldLeaderboardOverview` = new I18nKey("faq:shieldLeaderboardOverview")
val `firstPlaceShield` = new I18nKey("faq:firstPlaceShield")
val `secondPlaceShield` = new I18nKey("faq:secondPlaceShield")
val `thirdPlaceShield` = new I18nKey("faq:thirdPlaceShield")
val `playedAtLeastOneGameShield` = new I18nKey("faq:playedAtLeastOneGameShield")
val `otherShieldLeaderboardRestrictons` = new I18nKey("faq:otherShieldLeaderboardRestrictons")
...
val `playstrategyCanOptionnalySendPopUps` = new I18nKey("faq:playstrategyCanOptionnalySendPopUps")
}

object lag {
val `isPlayStrategyLagging` = new I18nKey("lag:isPlayStrategyLagging")
...
val `playstrategyServerLatency` = new I18nKey("lag:playstrategyServerLatency")
val `playstrategyServerLatencyExplanation` = new I18nKey("lag:playstrategyServerLatencyExplanation")
val `networkBetweenPlayStrategyAndYou` = new I18nKey("lag:networkBetweenPlayStrategyAndYou")
val `networkBetweenPlayStrategyAndYouExplanation` = new I18nKey("lag:networkBetweenPlayStrategyAndYouExplanation")
...
val `puzzleFAQ` = new I18nKey("puzzle:puzzleFAQ")
...
val `wins` = new I18nKey("puzzle:wins")
...
val `findTheBestMoveForPlayerIndex` = new I18nKey("puzzle:findTheBestMoveForPlayerIndex")
...
val `whatPuzzlesAreAvailable` = new I18nKey("puzzle:whatPuzzlesAreAvailable")
val `whatPuzzlesAreAvailableANS` = new I18nKey("puzzle:whatPuzzlesAreAvailableANS")
val `whatArePuzzleThemes` = new I18nKey("puzzle:whatArePuzzleThemes")
val `whatArePuzzleThemesANS` = new I18nKey("puzzle:whatArePuzzleThemesANS")
val `whatIsPuzzleRating` = new I18nKey("puzzle:whatIsPuzzleRating")
val `whatIsPuzzleRatingANS` = new I18nKey("puzzle:whatIsPuzzleRatingANS")
val `howCalculateNextPuzzle` = new I18nKey("puzzle:howCalculateNextPuzzle")
val `howCalculateNextPuzzleANS` = new I18nKey("puzzle:howCalculateNextPuzzleANS")
val `whyLoopingPuzzles` = new I18nKey("puzzle:whyLoopingPuzzles")
val `whyLoopingPuzzlesANS` = new I18nKey("puzzle:whyLoopingPuzzlesANS")
val `differenceBetweenRatingAndPerformance` = new I18nKey("puzzle:differenceBetweenRatingAndPerformance")
val `differenceBetweenRatingAndPerformanceANS` = new I18nKey("puzzle:differenceBetweenRatingAndPerformanceANS")
val `howDailyPuzzleChosen` = new I18nKey("puzzle:howDailyPuzzleChosen")
val `howDailyPuzzleChosenANS` = new I18nKey("puzzle:howDailyPuzzleChosenANS")
val `whyMySolutionIsIncorrect` = new I18nKey("puzzle:whyMySolutionIsIncorrect")
val `whyMySolutionIsIncorrectANS` = new I18nKey("puzzle:whyMySolutionIsIncorrectANS")
val `futurePuzzlePlans` = new I18nKey("puzzle:futurePuzzlePlans")
val `futurePuzzlePlansANS` = new I18nKey("puzzle:futurePuzzlePlansANS")
val `side` = new I18nKey("puzzle:side")
...
val `kingOnHill` = new I18nKey("puzzleTheme:kingOnHill")
val `kingOnHillDescription` = new I18nKey("puzzleTheme:kingOnHillDescription")
val `kingOnHillIn1` = new I18nKey("puzzleTheme:kingOnHillIn1")
val `kingOnHillIn1Description` = new I18nKey("puzzleTheme:kingOnHillIn1Description")
val `kingOnHillIn2` = new I18nKey("puzzleTheme:kingOnHillIn2")
val `kingOnHillIn2Description` = new I18nKey("puzzleTheme:kingOnHillIn2Description")
val `kingOnHillIn3` = new I18nKey("puzzleTheme:kingOnHillIn3")
val `kingOnHillIn3Description` = new I18nKey("puzzleTheme:kingOnHillIn3Description")
...
val `win` = new I18nKey("puzzleTheme:win")
val `winDescription` = new I18nKey("puzzleTheme:winDescription")
val `winIn1` = new I18nKey("puzzleTheme:winIn1")
val `winIn1Description` = new I18nKey("puzzleTheme:winIn1Description")
val `winIn2` = new I18nKey("puzzleTheme:winIn2")
val `winIn2Description` = new I18nKey("puzzleTheme:winIn2Description")
val `winIn3` = new I18nKey("puzzleTheme:winIn3")
val `winIn3Description` = new I18nKey("puzzleTheme:winIn3Description")
...
val `pawns` = new I18nKey("puzzleTheme:pawns")
val `pawnsDescription` = new I18nKey("puzzleTheme:pawnsDescription")
val `pieces` = new I18nKey("puzzleTheme:pieces")
val `piecesDescription` = new I18nKey("puzzleTheme:piecesDescription")
...
val `youPlayThePlayerIndexPiecesInAllPuzzles` = new I18nKey("storm:youPlayThePlayerIndexPiecesInAllPuzzles")
...
object variantName {
val `chess` = new I18nKey("variantName:chess")
val `standard` = new I18nKey("variantName:standard")
val `fromPosition` = new I18nKey("variantName:fromPosition")
val `antichess` = new I18nKey("variantName:antichess")
val `atomic` = new I18nKey("variantName:atomic")
val `chess960` = new I18nKey("variantName:chess960")
val `crazyhouse` = new I18nKey("variantName:crazyhouse")
val `fiveCheck` = new I18nKey("variantName:fiveCheck")
val `horde` = new I18nKey("variantName:horde")
val `kingOfTheHill` = new I18nKey("variantName:kingOfTheHill")
val `monster` = new I18nKey("variantName:monster")
val `noCastling` = new I18nKey("variantName:noCastling")
val `racingKings` = new I18nKey("variantName:racingKings")
val `threeCheck` = new I18nKey("variantName:threeCheck")
val `linesOfAction` = new I18nKey("variantName:linesOfAction")
val `scrambledEggs` = new I18nKey("variantName:scrambledEggs")
val `draughts` = new I18nKey("variantName:draughts")
val `international` = new I18nKey("variantName:international")
val `draughtsFromPosition` = new I18nKey("variantName:draughtsFromPosition")
val `antidraughts` = new I18nKey("variantName:antidraughts")
val `brazilian` = new I18nKey("variantName:brazilian")
val `breakthrough` = new I18nKey("variantName:breakthrough")
val `frisian` = new I18nKey("variantName:frisian")
val `frysk` = new I18nKey("variantName:frysk")
val `pool` = new I18nKey("variantName:pool")
val `russian` = new I18nKey("variantName:russian")
val `portuguese` = new I18nKey("variantName:portuguese")
val `english` = new I18nKey("variantName:english")
val `dameo` = new I18nKey("variantName:dameo")
val `shogi` = new I18nKey("variantName:shogi")
val `xiangqi` = new I18nKey("variantName:xiangqi")
val `minishogi` = new I18nKey("variantName:minishogi")
val `minixiangqi` = new I18nKey("variantName:minixiangqi")
val `flipello` = new I18nKey("variantName:flipello")
val `flipello10` = new I18nKey("variantName:flipello10")
val `antiflipello` = new I18nKey("variantName:antiflipello")
val `octagonflipello` = new I18nKey("variantName:octagonflipello")
val `amazons` = new I18nKey("variantName:amazons")
val `breakthroughtroyka` = new I18nKey("variantName:breakthroughtroyka")
val `minibreakthroughtroyka` = new I18nKey("variantName:minibreakthroughtroyka")
val `oware` = new I18nKey("variantName:oware")
val `mancala` = new I18nKey("variantName:mancala")
val `togyzkumalak` = new I18nKey("variantName:togyzkumalak")
val `bestemshe` = new I18nKey("variantName:bestemshe")
val `go` = new I18nKey("variantName:go")
val `go9x9` = new I18nKey("variantName:go9x9")
val `go13x13` = new I18nKey("variantName:go13x13")
val `go19x19` = new I18nKey("variantName:go19x19")
val `backgammon` = new I18nKey("variantName:backgammon")
val `hyper` = new I18nKey("variantName:hyper")
...
val `standard` = new I18nKey("variantShortName:standard")
val `fromPosition` = new I18nKey("variantShortName:fromPosition")
val `antichess` = new I18nKey("variantShortName:antichess")
val `atomic` = new I18nKey("variantShortName:atomic")
val `chess960` = new I18nKey("variantShortName:chess960")
val `crazyhouse` = new I18nKey("variantShortName:crazyhouse")
val `fiveCheck` = new I18nKey("variantShortName:fiveCheck")
val `horde` = new I18nKey("variantShortName:horde")
val `kingOfTheHill` = new I18nKey("variantShortName:kingOfTheHill")
val `monster` = new I18nKey("variantShortName:monster")
val `noCastling` = new I18nKey("variantShortName:noCastling")
val `racingKings` = new I18nKey("variantShortName:racingKings")
val `threeCheck` = new I18nKey("variantShortName:threeCheck")
val `linesOfAction` = new I18nKey("variantShortName:linesOfAction")
val `scrambledEggs` = new I18nKey("variantShortName:scrambledEggs")
val `international` = new I18nKey("variantShortName:international")
val `draughtsFromPosition` = new I18nKey("variantShortName:draughtsFromPosition")
val `antidraughts` = new I18nKey("variantShortName:antidraughts")
val `brazilian` = new I18nKey("variantShortName:brazilian")
val `breakthrough` = new I18nKey("variantShortName:breakthrough")
val `frisian` = new I18nKey("variantShortName:frisian")
val `frysk` = new I18nKey("variantShortName:frysk")
val `pool` = new I18nKey("variantShortName:pool")
val `russian` = new I18nKey("variantShortName:russian")
val `portuguese` = new I18nKey("variantShortName:portuguese")
val `english` = new I18nKey("variantShortName:english")
val `dameo` = new I18nKey("variantShortName:dameo")
val `shogi` = new I18nKey("variantShortName:shogi")
val `xiangqi` = new I18nKey("variantShortName:xiangqi")
val `minishogi` = new I18nKey("variantShortName:minishogi")
val `minixiangqi` = new I18nKey("variantShortName:minixiangqi")
val `flipello` = new I18nKey("variantShortName:flipello")
val `flipello10` = new I18nKey("variantShortName:flipello10")
val `antiflipello` = new I18nKey("variantShortName:antiflipello")
val `octagonflipello` = new I18nKey("variantShortName:octagonflipello")
val `amazons` = new I18nKey("variantShortName:amazons")
val `breakthroughtroyka` = new I18nKey("variantShortName:breakthroughtroyka")
val `minibreakthroughtroyka` = new I18nKey("variantShortName:minibreakthroughtroyka")
val `oware` = new I18nKey("variantShortName:oware")
val `togyzkumalak` = new I18nKey("variantShortName:togyzkumalak")
val `bestemshe` = new I18nKey("variantShortName:bestemshe")
val `go9x9` = new I18nKey("variantShortName:go9x9")
val `go13x13` = new I18nKey("variantShortName:go13x13")
val `go19x19` = new I18nKey("variantShortName:go19x19")
val `backgammon` = new I18nKey("variantShortName:backgammon")
val `hyper` = new I18nKey("variantShortName:hyper")
...
object variantTitle {
val `standard` = new I18nKey("variantTitle:standard")
val `fromPosition` = new I18nKey("variantTitle:fromPosition")
val `antichess` = new I18nKey("variantTitle:antichess")
val `atomic` = new I18nKey("variantTitle:atomic")
val `chess960` = new I18nKey("variantTitle:chess960")
val `crazyhouse` = new I18nKey("variantTitle:crazyhouse")
val `fiveCheck` = new I18nKey("variantTitle:fiveCheck")
val `horde` = new I18nKey("variantTitle:horde")
val `kingOfTheHill` = new I18nKey("variantTitle:kingOfTheHill")
val `monster` = new I18nKey("variantTitle:monster")
val `noCastling` = new I18nKey("variantTitle:noCastling")
val `racingKings` = new I18nKey("variantTitle:racingKings")
val `threeCheck` = new I18nKey("variantTitle:threeCheck")
val `linesOfAction` = new I18nKey("variantTitle:linesOfAction")
val `scrambledEggs` = new I18nKey("variantTitle:scrambledEggs")
val `international` = new I18nKey("variantTitle:international")
val `draughtsFromPosition` = new I18nKey("variantTitle:draughtsFromPosition")
val `antidraughts` = new I18nKey("variantTitle:antidraughts")
val `brazilian` = new I18nKey("variantTitle:brazilian")
val `breakthrough` = new I18nKey("variantTitle:breakthrough")
val `frisian` = new I18nKey("variantTitle:frisian")
val `frysk` = new I18nKey("variantTitle:frysk")
val `pool` = new I18nKey("variantTitle:pool")
val `russian` = new I18nKey("variantTitle:russian")
val `portuguese` = new I18nKey("variantTitle:portuguese")
val `english` = new I18nKey("variantTitle:english")
val `dameo` = new I18nKey("variantTitle:dameo")
val `shogi` = new I18nKey("variantTitle:shogi")
val `xiangqi` = new I18nKey("variantTitle:xiangqi")
val `minishogi` = new I18nKey("variantTitle:minishogi")
val `minixiangqi` = new I18nKey("variantTitle:minixiangqi")
val `flipello` = new I18nKey("variantTitle:flipello")
val `flipello10` = new I18nKey("variantTitle:flipello10")
val `antiflipello` = new I18nKey("variantTitle:antiflipello")
val `octagonflipello` = new I18nKey("variantTitle:octagonflipello")
val `amazons` = new I18nKey("variantTitle:amazons")
val `breakthroughtroyka` = new I18nKey("variantTitle:breakthroughtroyka")
val `minibreakthroughtroyka` = new I18nKey("variantTitle:minibreakthroughtroyka")
val `oware` = new I18nKey("variantTitle:oware")
val `togyzkumalak` = new I18nKey("variantTitle:togyzkumalak")
val `bestemshe` = new I18nKey("variantTitle:bestemshe")
val `go9x9` = new I18nKey("variantTitle:go9x9")
val `go13x13` = new I18nKey("variantTitle:go13x13")
val `go19x19` = new I18nKey("variantTitle:go19x19")
val `backgammon` = new I18nKey("variantTitle:backgammon")
val `hyper` = new I18nKey("variantTitle:hyper")
...
object variantAlias {
val `standard` = new I18nKey("variantAlias:standard")
val `fromPosition` = new I18nKey("variantAlias:fromPosition")
val `antichess` = new I18nKey("variantAlias:antichess")
val `atomic` = new I18nKey("variantAlias:atomic")
val `chess960` = new I18nKey("variantAlias:chess960")
val `crazyhouse` = new I18nKey("variantAlias:crazyhouse")
val `fiveCheck` = new I18nKey("variantAlias:fiveCheck")
val `horde` = new I18nKey("variantAlias:horde")
val `kingOfTheHill` = new I18nKey("variantAlias:kingOfTheHill")
val `monster` = new I18nKey("variantAlias:monster")
val `noCastling` = new I18nKey("variantAlias:noCastling")
val `racingKings` = new I18nKey("variantAlias:racingKings")
val `threeCheck` = new I18nKey("variantAlias:threeCheck")
val `linesOfAction` = new I18nKey("variantAlias:linesOfAction")
val `scrambledEggs` = new I18nKey("variantAlias:scrambledEggs")
val `international` = new I18nKey("variantAlias:international")
val `draughtsFromPosition` = new I18nKey("variantAlias:draughtsFromPosition")
val `antidraughts` = new I18nKey("variantAlias:antidraughts")
val `brazilian` = new I18nKey("variantAlias:brazilian")
val `breakthrough` = new I18nKey("variantAlias:breakthrough")
val `frisian` = new I18nKey("variantAlias:frisian")
val `frysk` = new I18nKey("variantAlias:frysk")
val `pool` = new I18nKey("variantAlias:pool")
val `russian` = new I18nKey("variantAlias:russian")
val `portuguese` = new I18nKey("variantAlias:portuguese")
val `english` = new I18nKey("variantAlias:english")
val `dameo` = new I18nKey("variantAlias:dameo")
val `shogi` = new I18nKey("variantAlias:shogi")
val `xiangqi` = new I18nKey("variantAlias:xiangqi")
val `minishogi` = new I18nKey("variantAlias:minishogi")
val `minixiangqi` = new I18nKey("variantAlias:minixiangqi")
val `flipello` = new I18nKey("variantAlias:flipello")
val `flipello10` = new I18nKey("variantAlias:flipello10")
val `antiflipello` = new I18nKey("variantAlias:antiflipello")
val `octagonflipello` = new I18nKey("variantAlias:octagonflipello")
val `amazons` = new I18nKey("variantAlias:amazons")
val `breakthroughtroyka` = new I18nKey("variantAlias:breakthroughtroyka")
val `minibreakthroughtroyka` = new I18nKey("variantAlias:minibreakthroughtroyka")
val `oware` = new I18nKey("variantAlias:oware")
val `togyzkumalak` = new I18nKey("variantAlias:togyzkumalak")
val `bestemshe` = new I18nKey("variantAlias:bestemshe")
val `go9x9` = new I18nKey("variantAlias:go9x9")
val `go13x13` = new I18nKey("variantAlias:go13x13")
val `go19x19` = new I18nKey("variantAlias:go19x19")
val `backgammon` = new I18nKey("variantAlias:backgammon")
val `hyper` = new I18nKey("variantAlias:hyper")
