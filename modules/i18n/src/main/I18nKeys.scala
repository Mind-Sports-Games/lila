...
val `sgPlayerIsVictorious` = new I18nKey("sgPlayerIsVictorious")
...
val `youPlayTheSGPlayerPieces` = new I18nKey("youPlayTheSGPlayerPieces")
...
val `sgPlayerPlays` = new I18nKey("sgPlayerPlays")
...
val `sgPlayerResigned` = new I18nKey("sgPlayerResigned")
val `whiteResigned` = new I18nKey("whiteResigned")
val `blackResigned` = new I18nKey("blackResigned")
val `sgPlayerLeftTheGame` = new I18nKey("sgPlayerLeftTheGame")
...
val `sgPlayerTimeOut` = new I18nKey("sgPlayerTimeOut")
...
val `sgPlayerOffersDraw` = new I18nKey("sgPlayerOffersDraw")
val `whiteOffersDraw` = new I18nKey("whiteOffersDraw")
val `blackOffersDraw` = new I18nKey("blackOffersDraw")
val `sgPlayerDeclinesDraw` = new I18nKey("sgPlayerDeclinesDraw")
...
val `rematchOfferSentSGPlayer` = new I18nKey("rematchOfferSentSGPlayer")
...
val `sgPlayerCheckmatesInOneMove` = new I18nKey("sgPlayerCheckmatesInOneMove")
...
val `sgPlayerWins` = new I18nKey("sgPlayerWins")
...
val `sgPlayerWinsGame` = new I18nKey("sgPlayerWinsGame")
...
val `findBetterMoveForSGPlayer` = new I18nKey("findBetterMoveForSGPlayer")
...
val `tryAnotherMoveForSGPlayer` = new I18nKey("tryAnotherMoveForSGPlayer")
...
val `noMistakesFoundForSGPlayer` = new I18nKey("noMistakesFoundForSGPlayer")
...
val `doneReviewingSGPlayerMistakes` = new I18nKey("doneReviewingSGPlayerMistakes")
...
val `reviewSGPlayerMistakes` = new I18nKey("reviewSGPlayerMistakes")
...
val `averageScoreAsSGPlayerX` = new I18nKey("coordinates:averageScoreAsSGPlayerX")
...
val `sgPlayerIsSlightlyBetter` = new I18nKey("study:sgPlayerIsSlightlyBetter")
val `sgPlayerIsBetter` = new I18nKey("study:sgPlayerIsBetter")
val `sgPlayerIsWinning` = new I18nKey("study:sgPlayerIsWinning")
...
val `findTheBestMoveForSGPlayer` = new I18nKey("puzzle:findTheBestMoveForSGPlayer")
...
val `youPlayTheSGPlayerPiecesInAllPuzzles` = new I18nKey("storm:youPlayTheSGPlayerPiecesInAllPuzzles")
