...
case class Perfs(
  ...
  def apply(perfType: PerfType): Perf = perfsMap(perfType.key)
...
case object Perfs {
  ...
  val emptyLeaderboards = Leaderboards(Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil, Nil)
}
