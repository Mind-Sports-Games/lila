...
object Quote {
  ...
  val gameFamilySpecific: Map[GameFamily, Vector[Quote]] = Map(
    ...
    GameFamily.Draughts() -> Vector(
      ...
      new Quote(
        "A person is born, and a person dies. In between there is the possibility to play draughts.",
        "Jannes van der Wal"
      ),
      new Quote(
      ...
      new Quote(
        "The most important element for success is to love what you do and do what you love. ",
        "Alexander Georgiev"
      ),
      new Quote(
        "I studied economics in Saint Petersburg, but when I became European champion in 1995, I decided to become a professional draughts player. That seemed to be more exciting than a boring life as a bookkeeper.",
        "Alexander Georgiev"
      ),
      new Quote(
        "Playing a simultaneous exhibition gives me lots of pleasure. I like people liking, that's for me the best!",
        "Alexander Schwartzman"
      ),
      new Quote(
        "Draughts players complain too much, they shouldn't compare themselves to chess players. We should propagate that we practice the most beautiful game. The endless spaces make draughts fascinating. Its magic lies in the limitless possibilities.",
        "Roel Boomstra"
      ),
      new Quote(
      ...
      new Quote(
        "I will, therefore, take occasion to assert that the higher powers of the reflective intellect are more decidedly and more usefully tasked by the unostentatious game of draughts than by the elaborate frivolity of chess.",
        "Edgar Allan Poe"
      ),
      new Quote("Of all mind sports, draughts is the most beautiful.", "Pierre Ghestem"),
      new Quote(
        "Baba Sy had opened our eyes. Africa was not only good in dancing and football, but also in mindgames, Baba Sy became the ambassador of the continent. In Senegal everyone speaks about him with great respect.",
        "Macodou N'Diaye"
      ),
      new Quote("Let's play draughts!", "Klaas Leijenaar")
    ),
    GameFamily.Shogi() -> Vector(
