...
db.tournament2
  .find({ 'schedule.freq': 'shield', startsAt: { $gte: ISODate('2024-05-01'), $lt: ISODate('2024-06-01') } })
  .count();
...
db.tournament2.aggregate([
  {
    $match: {
      $and: [{ 'schedule.freq': 'shield' }, { startsAt: { $gte: ISODate('2024-05-01'), $lt: ISODate('2024-06-01') } }],
    },
  },
  ...
  { $unwind: '$tour' },
  {
    $match: {
      $and: [
        ...
        { 'tour.startsAt': { $gte: ISODate('2024-05-01'), $lt: ISODate('2024-06-01') } },
        { u: 'pst-greedy-tom' },
      ],
    },
  },
