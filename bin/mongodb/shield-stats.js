...
db.tournament2
  .find({ 'schedule.freq': 'shield', startsAt: { $gte: ISODate('2024-01-01'), $lt: ISODate('2024-02-01') } })
  .count();
...
db.tournament2.aggregate([
  {
    $match: {
      $and: [{ 'schedule.freq': 'shield' }, { startsAt: { $gte: ISODate('2024-01-01'), $lt: ISODate('2024-02-01') } }],
    },
  },
  ...
  { $unwind: '$tour' },
  {
    $match: {
      $and: [
        ...
        { 'tour.startsAt': { $gte: ISODate('2024-01-01'), $lt: ISODate('2024-02-01') } },
        { u: 'pst-greedy-tom' },
      ],
    },
  },
