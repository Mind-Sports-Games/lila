...
db.tournament2
  .find({ 'schedule.freq': 'shield', startsAt: { $gte: ISODate('2026-08-01'), $lt: ISODate('2026-09-01') } })
  .count();
...
db.tournament2.aggregate([
  {
    $match: {
      $and: [{ 'schedule.freq': 'shield' }, { startsAt: { $gte: ISODate('2026-08-01'), $lt: ISODate('2026-09-01') } }],
    },
  },
  ...
  { $unwind: '$tour' },
  {
    $match: {
      $and: [
        ...
        { 'tour.startsAt': { $gte: ISODate('2026-08-01'), $lt: ISODate('2026-09-01') } },
        { u: 'pst-greedy-tom' },
      ],
    },
  },
