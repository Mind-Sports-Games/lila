...
//View the data:
db.tournament_leaderboard.aggregate([{$lookup: {from: 'tournament2',localField: 't',foreignField: '_id',as: 'tour'}}, {$unwind: '$tour'}, {$match: {'tour.schedule.freq': 'shield'}},  {$project: {'u': 1, 'tour.name': 1, 'tour._id': 1, 'tour.status': 1, 'r': 1, 's': 1, 'g': 1 }} ]);
