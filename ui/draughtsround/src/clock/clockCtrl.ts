...
export class ClockController {
  ...
  constructor(
    ...
    //this line is additional in comparison to round version of this file
    //doesn't make much sense to exist but without doing extensive testing its a bad idea to remove it
