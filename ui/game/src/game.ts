...
export const playerHasPlayedTurn = (data: BaseGameData): boolean => playedTurns(data) > ((data.game.startedAtTurn !== undefined && data.game.startedAtTurn % 2 == 1) ? (data.player.playerIndex == 'p1' ? 1 : 0) : (data.player.playerIndex == 'p1' ? 0 : 1));
