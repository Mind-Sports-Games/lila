...
export interface State {
  ...
  coordSystem?: number; // coordinate system (0 = fieldnumbers, 1 = algebraic, 2 = fieldnumbers inverted)
...
export function defaults(): Partial<State> {
  return {
    ...
    drawable: {
      ...
      pieces: {
        baseUrl: 'https://playstrategy.org/assets/piece/draughts/wide_crown/',
      },
      prevSvgHash: '',
    },
    hold: timer(),
